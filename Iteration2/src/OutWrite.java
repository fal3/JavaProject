...
public class OutWrite {
	...
	public static void main(String[] args) {
		try{
			...
			File svg = null;
			try{
			       svg = new File("Alex/Downloads/512px-A-letter.svg.png");
			...
			Scanner readFile = new Scanner(svg);
			
			
			
			pw.println("<glyph unicode=\"&#xe601;\" d=\"M896 704h-192v128c0 35.2-28.8 64-64 64h-256c-35.2 0-64-28.8-64-64v-128h-192c-70.4 0-128-57.6-128-128v-512c0-70.4 57.6-128 128-128h768c70.4 0 128 57.6 128 128v512c0 70.4-57.6 128-128 128zM384 832h256v-128h-256v128zM768 256h-192v-192h-128v192h-192v128h192v192h128v-192h192v-128z\" />");
